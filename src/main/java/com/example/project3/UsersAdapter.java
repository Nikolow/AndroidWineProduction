...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UsersAdapterVh> implements Filterable {
    ...
    public interface SelectedUser{
        ...
        void selectedUser(UserModel userModel, int position);
        ...
        public UsersAdapterVh(@NonNull View itemView)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    selectedUser.selectedUser(userModelList.get(getAdapterPosition()), getAdapterPosition());
                }
            });
    ...
    {
        userModelList.add(position, userModel);
